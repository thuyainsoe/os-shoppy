  ...
  return (
    <div className="w-[48.9795%] h-full  flex flex-col gap-[14px]">
      ...
      <div className="w-full">
        <button className=" w-full bg-transparent hover:bg-skyblue text-skyblue font-semibold hover:text-white py-2 px-4 border border-skyblue hover:border-transparent rounded">
          Buy Now
        </button>
      </div>
    </div>
